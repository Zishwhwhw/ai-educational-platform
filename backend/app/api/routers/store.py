...
STORE_ITEMS = [
    StoreItem(
        id=1,
        name="Hacker Dark Theme",
        description="A cool neon green on black theme.",
        price_coins=500,
        item_type="theme",
    ),
    StoreItem(
        id=2,
        name="Pro Developer Avatar",
        description="Exclusive avatar border.",
        price_coins=250,
        item_type="avatar",
    ),
    StoreItem(
        id=3,
        name="Golden Code Badge",
